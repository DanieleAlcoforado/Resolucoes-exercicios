# Consultas em um banco de dados "Loja", utilizando SQL.
...
### Query para listar os códigos das vendas identificadas como deletadas. Apresente o resultado em ordem crescente.
```SQL
SELECT
	cdven
FROM
